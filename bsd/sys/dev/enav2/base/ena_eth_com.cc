...
static_assert(sizeof(struct ena_eth_io_tx_meta_desc) == (sizeof(struct ena_eth_io_tx_desc)),
...
static void ena_com_rx_set_flags(struct ena_com_rx_ctx *ena_rx_ctx,
				 struct ena_eth_io_rx_cdesc_ext *cdesc)
{
	ena_rx_ctx->l3_proto = (ena_eth_io_l3_proto_index)(cdesc->base.status &
		ENA_ETH_IO_RX_CDESC_BASE_L3_PROTO_IDX_MASK);
	ena_rx_ctx->l4_proto =
		(ena_eth_io_l4_proto_index)ENA_FIELD_GET(cdesc->base.status,
